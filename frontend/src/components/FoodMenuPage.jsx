...
const FoodMenuPage = () => {
  ...
  useEffect(() => {
    const fetchMenuData = async () => {
      try {
        const response = await axios.get(`${baseURL}/api/menu/menu`);
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-orange-50 to-amber-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-orange-800">Loading menu...</p>
        </div>
      </div>
    );
  }
          ...
          >
            ...
            {cart.length === 0 ? (
              ...
              <>
                ...
                <div className="mt-6 border-t border-orange-200 pt-4">
                  <div className="flex justify-between items-center text-lg font-semibold text-orange-800 mb-2">
                    <span>Total:</span>
